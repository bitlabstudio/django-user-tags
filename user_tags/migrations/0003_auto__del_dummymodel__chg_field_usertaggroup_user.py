...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserTagGroup.user'
        db.alter_column('user_tags_usertaggroup', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'UserTagGroup.user'
        raise RuntimeError("Cannot reverse this migration. 'UserTagGroup.user' and its values cannot be restored.")
